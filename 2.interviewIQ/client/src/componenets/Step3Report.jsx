...
//              <button onClick={downloadPDF} className="bg-emerald-600 hover:bg-emerald-700 text-white px-6
//              py-3 rounded-xl shadow-md transition-all duration-300 font-semibold
//              text-sm sm:text-base text-nowrap "> Download PDF
//                 </button>       
//             </div>
...
//                           sm:text-base leading-relaxed"> {q.question || "Question not available"}</p>
//                         </div>


//                         <div className="bg-green-100 text-green-600 px-3 py-1 
//                         rounded-full font-bold text-xs sm:text-sm w-fit">{q.score ?? 0}/10</div>
//                       </div>
